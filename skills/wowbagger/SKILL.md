...
```sh
npm install -g wowbagger@0.1.0-alpha.11
```
...
`0.1.0-alpha.11` and core `contract_version: 5`.**

The distribution pin names the published `0.1.0-alpha.11` release; the cut that
