...
```sh
npm install -g wowbagger@0.1.0-alpha.15
```
...
`0.1.0-alpha.15` and core `contract_version: 5`.**

The distribution pin names the published `0.1.0-alpha.15` release; the cut that
