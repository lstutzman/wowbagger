...
```sh
npm install -g wowbagger@0.1.0-alpha.10
```
...
`0.1.0-alpha.10` and core `contract_version: 5`.**

The distribution pin names the published `0.1.0-alpha.10` release; the cut that
