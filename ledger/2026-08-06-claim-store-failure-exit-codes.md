...
decisions:
  ...
  - action: record
    date: 2026-08-08
    summary: "Rank the claim-store failure exits at 20."
    rationale: "A claim store that cannot be read or written currently has no contract exit, so a coordination failure is indistinguishable from an ordinary refusal."
---
