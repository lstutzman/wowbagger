...
- `src/report-impact.js`
- `test/report-impact.test.js`
...
```sh
TMPDIR=/tmp /opt/homebrew/opt/node@24/bin/node --test test/report-impact.test.js test/report-ready-contract.test.js test/report-sequencing.test.js
```
