...
depends_on: [ wb_01M1RWN4TXN0MAE4C6EFHEGKN0 ]
related: []
...
```sh
TMPDIR=/tmp /opt/homebrew/opt/node@24/bin/node --test test/report-html.test.js test/report-svg.test.js test/report-evidence.test.js test/report-selection.test.js
```
