...
depends_on: [ wb_01M1RWN4XSQ4YWBD5GRZDDQKWF, wb_01M1RWN50G4QW1ZKV1R08KBEWK ]
related: []
...
Implement T8: Verify report redesign with reproducible offline browser artifacts. This is one standalone child of report epic #190. Scope and contracts are embedded here; the source plan is background, not a prerequisite for understanding the assignment. Parent ownership does not authorize taking another child's work.

## Required predecessors

- #197 — Connect scoped Flow charts to their contributing report items.
- #198 — Connect Dependencies graph and roster to shared report scope.
...
Use the complete gate and browser scenarios in this item’s T8 execution steps below.
