...
decisions:
  ...
  - action: complete
    date: 2026-08-22
    summary: "Complete CAS-fenced item snooze mutation."
    rationale: "Snooze sets and clears snoozed_until through an explicit CAS mutation, preserves item identity, and passes focused command tests."
---
