...
decisions:
  ...
  - action: complete
    date: 2026-08-30
    summary: "Ship target-scoped claim verification."
    rationale: "claim-verify now accepts an optional item target, preserves all findings with blocking annotations, retains strict repository mode, negotiates work-claim API 3, and passes the full Node 24 gates."
---
## Problem
