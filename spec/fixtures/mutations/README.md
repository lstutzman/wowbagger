...
| Patch | successful existing-number replacement, invalid numeric token, exact-field and decision-evidence validation, commented-frontmatter candidate refusal, stale revision, held lock, multi-item refusal |
