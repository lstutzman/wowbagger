...
- **frontmatter ownership boundary** — the four-way split of every frontmatter member into core-owned, consumer-editable through `patch`, mutable through a dedicated command, and create-once; stated member by member in the mutation contract's ownership table, never discovered from a refusal.
